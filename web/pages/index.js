    ...
    async function generateStory() {
        ...
        try {
            ...
            if (generationMethod === 'google-ai') {
                ...
                // Set pinyin if available
                if (data.pinyin) {
                    setPinyin(data.pinyin);
                } else {
                    setPinyin(""); // Clear if no pinyin provided
                }
                ...
                setPinyin(""); // Clear pinyin for GAN stories
            ...
            setPinyin(""); // Clear pinyin on error
            setVocabulary([]); // Clear vocabulary on error
        } finally {
            setLoading(false);
        }
    }
            ...
            <div style={{
                ...
                {story ? (
                    pinyin ? (
                        ...
                        <div style={{ 
                            lineHeight: "1.6",
                            backgroundColor: currentSentenceIndex >= 0 ? "#fff3cd" : "transparent",
                            padding: "8px",
                            borderRadius: "4px"
                        }}>
                            {story}
